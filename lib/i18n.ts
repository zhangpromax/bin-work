...
const I18N: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    tabhome: '首页', tabprofile: '档案', tabhealth: '健康', tabmine: '我的', quick: '记录',
    todaytodo: '今日待办', recent: '最近动态', babies: '宝宝', addbaby: '添加宝宝',
  ...
  en: {
    ...
    tabhome: 'Home', tabprofile: 'Profiles', tabhealth: 'Health', tabmine: 'Mine', quick: 'Log',
    todaytodo: 'Today', recent: 'Recent', babies: 'Babies', addbaby: 'Add Baby',
