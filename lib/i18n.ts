...
const I18N: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    feedRemind: '喂养与提醒', feedRemindSub: '喂养设置 · 提醒设置',
    storage: '存储', storageSub: '云空间使用情况', usedSpace: '已用空间', cloudSpace: '云空间',
    lastSync: '上次同步', syncBtn: '立即同步', syncing: '同步中…', realtimeTip: '数据大小随记录实时更新', localOnlyStorage: '本地模式：数据仅存本机',
    smile: '第一次微笑', rollover: '第一次翻身', sit: '独坐', teeth: '第一颗牙', crawl: '爬行', stand: '扶站', walk: '迈出第一步', talk: '说出第一个词', callparents: '叫爸爸妈妈', recognize: '认人',
    milestone: '成长记录', mileadd: '记录里程碑', milelabel: '里程碑', dailycare: '日常护理', healthcare: '健康医疗', growthdata: '成长数据',
    headcirc: '头围',
    addBabyTip: '还没有宝宝，点击添加', growthEmptyTitle: '开启宝宝的成长档案', growthEmptySub: '添加宝宝后，这里会自动生成里程碑与体重曲线', daysOld: '天', syncStatus: '数据同步中',
    ...
    enabled: '启用',
    growthCurve: '成长曲线', growthGuide: '发育里程碑', growthGuideSub: '按宝宝生日自动生成 · 权威指南提醒',
    currentStage: '当前阶段', msReached: '已到', msUpcoming: '未到', msTodo: '当前待办', msViewAll: '查看全部里程碑', msCollapse: '收起',
  ...
  en: {
    ...
    feedRemind: 'Feeding & Reminders', feedRemindSub: 'Feeding · Reminder settings',
    storage: 'Storage', storageSub: 'Cloud storage usage', usedSpace: 'Used', cloudSpace: 'Cloud quota',
    lastSync: 'Last sync', syncBtn: 'Sync now', syncing: 'Syncing…', realtimeTip: 'Data size updates in real time as you log', localOnlyStorage: 'Local mode: data stored on this device only',
    ...
    milestone: 'Growth Log', mileadd: 'Add milestone', milelabel: 'Milestone', dailycare: 'Daily Care', healthcare: 'Health & Medical', growthdata: 'Growth Data',
    headcirc: 'Head',
    addBabyTip: 'No baby yet, tap to add', growthEmptyTitle: 'Start your baby’s growth journal', growthEmptySub: 'Add a baby to auto-generate milestones & weight curves', daysOld: 'days', syncStatus: 'syncing',
    ...
    enabled: 'Enabled',
    growthCurve: 'Growth Curve', growthGuide: 'Developmental Milestones', growthGuideSub: 'Auto from baby birthday · official guidelines',
    currentStage: 'Current stage', msReached: 'Due', msUpcoming: 'Upcoming', msTodo: 'To do now', msViewAll: 'View all milestones', msCollapse: 'Collapse',
